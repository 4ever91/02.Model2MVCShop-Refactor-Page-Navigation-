...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><%=vo.getPurchaseProd().getProdName() %></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><%=vo.getPurchaseProd().getProdDetail() %></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><%=vo.getPurchaseProd().getManuDate() %></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><%=vo.getPurchaseProd().getPrice() %></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><%=vo.getPurchaseProd().getRegDate() %></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="receiverPhone" class="ct_input_g" 
							style="width: 100px; height: 19px" maxLength="20" value="010-0000-0000" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
